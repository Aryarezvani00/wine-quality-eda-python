...
`data/wine_full.csv` — combined red and white wine samples with the following fields:

`fixed acidity`, `volatile acidity`, `citric acid`, `residual sugar`, `chlorides`, `free sulfur dioxide`, `total sulfur dioxide`, `density`, `pH`, `sulphates`, `alcohol`, `quality`, `color`

## Approach

Full analysis is in [`wine_quality_analysis.ipynb`](./wine_quality_analysis.ipynb), using **pandas** for data handling, and **seaborn** / **matplotlib** for visualization.
